...
SUMMARY_COLUMNS = [
    ...
    "Biological_Interpretation_Eligible", "Spacing_Resolution_Audit_Status",
    "Estimated_Effective_Grid_Da", "Integer_Isotope_Distinguishable",
    "Isotope_Interpretation_Eligible", "Spacing_Resolution_Warning_Code",
    "Relation_Evidence_Audit_Status", "Highest_Available_Evidence_Tier",
    "Resolution_Ambiguous_Relation_Count", "Interpretation_Eligible_Relation_Count",
    "Cluster_Tolerance_Da",
