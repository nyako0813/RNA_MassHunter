...
TOP_CANDIDATE_COLUMNS = [
    ...
    "Modification_ID",
    "Modification_Name",
    "Has_Known_Modification_Candidate",
    "Has_Compound_Modification_Candidate",
    "Has_Unknown_Modification_Candidate",
...
CHECKLIST_COLUMNS = [
    ...
    "Compound_Modification_Candidate",
    "Unknown_Modification_Candidate",
        ...
        rows.append(
            {
                ...
                "Has_Known_Modification_Candidate": bool(row.get("Has_Known_Modification_Candidate")),
                "Has_Compound_Modification_Candidate": bool(row.get("Has_Compound_Modification_Candidate")),
                "Has_Unknown_Modification_Candidate": bool(row.get("Has_Unknown_Modification_Candidate")),
                "Base_Modification_ID": row.get("Base_Modification_ID", ""),
        ...
        rows.append(
            {
                ...
                # Was `bool(row.get("Modification_ID"))`, which also matched Compound/Unknown
                # pseudo ids ("<base>+<delta>" / "UNKNOWN:<delta>") and always evaluated to
                # True. Use the real per-type flags carried through from ranking instead.
                "Known_Modification_Candidate": bool(row.get("Has_Known_Modification_Candidate")),
                "Compound_Modification_Candidate": bool(row.get("Has_Compound_Modification_Candidate")),
                "Unknown_Modification_Candidate": bool(row.get("Has_Unknown_Modification_Candidate")),
