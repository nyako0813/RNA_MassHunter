...
AUDIT_SUMMARY_SHEETS = {
    ...
    "SCIEX_Relation_Evidence_Summary",
...
AUDIT_DETAIL_SHEETS = {
    ...
    "Composite_MS2_Matches", "Composite_MS2_Assignment_Compe",
    "Composite_Structure_Position_Ma", "Composite_Structure_Bond_Map",
    "Blocked_Cleavage_Matches", "Composite_Obs_Invalid",
