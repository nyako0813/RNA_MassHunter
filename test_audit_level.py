...
def make_report(tmp_path, level):
    ...
    optional={
        ...
        "P1_SAP_Dinuc_Summary":[{"Model_Version":"test","Applied_To_Formal_Result":False,"Formal_Change_Ready":False,"Formal_Result_Changed":False}],
        "P1_SAP_Dinuc_Groups":[{"Dinucleotide_Group_ID":"d1","Applied_To_Formal_Result":False,"Formal_Change_Ready":False,"Formal_Result_Changed":False}],
        "P1_SAP_Dinuc_Assignments":[{"Dinucleotide_Group_ID":"d1","Applied_To_Formal_Result":False,"Formal_Change_Ready":False,"Formal_Result_Changed":False}],
        "P1_SAP_Dinuc_SpecPeaks":[{"Dinucleotide_Group_ID":"d1","Applied_To_Formal_Result":False,"Formal_Change_Ready":False,"Formal_Result_Changed":False}],
        "P1_SAP_Dinuc_Features":[{"Dinucleotide_Group_ID":"d1","Applied_To_Formal_Result":False,"Formal_Change_Ready":False,"Formal_Result_Changed":False}],
        "P1_SAP_Dinuc_Isotopes":[{"Dinucleotide_Group_ID":"d1","Applied_To_Formal_Result":False,"Formal_Change_Ready":False,"Formal_Result_Changed":False}],
